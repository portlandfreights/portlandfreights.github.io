...
value=value.replace(/&/g,'&amp;').replace(/"/g,"&quot;");return value;};$.fbuilder['htmlDecode']=function(value)
...
{var me=this;me.setEvents();me.setDefaultDate();me.setDefaultTime();$('#'+this.name+'_date').change();var validator=function(v,e)
{try
